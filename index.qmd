---
title: "Schwa to /a/: Input Quantity and Quality in L2 Morphophonoloy"
...
How do [input quantity]{.emph} and [input quality]{.emph} impact phonetic development?
...
- So acquisition of unstressed /a/ is wrapped up in...
  - [phonetics]{.emph}: modification of tongue height & backness to approach Spanish /a/
...
1. Do L1 English L2 Spanish learners in an immersion program demonstrate less centralization of unstressed /a/ over the course of seven weeks?

2. Does their development depend on a measure of language input?

## Participants

- [Ten]{.emph} L1 English L2 Spanish upper A2 learners
- [Seven weeks]{.emph} of domestic immersion program
...
::: {.fragment}
- in dyad of low + high prof learners, lower prof L2 learner speak less in some conditions [@yule1990resolving]
...
- Maybe it's a matter of [attention]{.emph}?
...
::: {.fragment}
- The clearest, strongest predictors were `total English use` and `total Spanish use`
- Interacting with speakers much higher in proficiency than you may slow [phonetic]{.emph} development?
